...
Examples:
    python cleanup.py sonic
    python cleanup.py strands
"""
...
class AgentCoreCleanup:
    ...
    def _print_available_folders(self):
        ...
        print("\nAvailable folders:")
        for folder in ['sonic', 'strands', 'langchain', 'echo']:
    ...
    def cleanup_with_agentcore_toolkit(self) -> bool:
        ...
        try:
            ...
            result = self._run_command(['agentcore', 'destroy', '--force'], check=False)
    ...
    def delete_config_file(self):
        ...
        if self.gateway_config_file.exists():
            self._print(f"\n🗑️  Deleting gateway configuration file: {self.gateway_config_file}", Colors.YELLOW)
...
Examples:
  ...
  python cleanup.py strands
    ...
    parser.add_argument(
        ...
        help='Websocket folder to clean up (sonic, strands, langchain, or echo)'
    )
