...
exports.KnowledgeBaseToolSchema = JSON.stringify({
    "type": "object",
    "properties": {
        "query": {
            "type": "string",
...
exports.DatabaseToolSchema = JSON.stringify({
    "type": "object",
    "properties": {
        "query": {
            "type": "string",
...
exports.GreetingToolSchema = JSON.stringify({
    "type": "object",
    "properties": {
        "greeting_type": {
            "type": "string",
...
exports.SafetyToolSchema = JSON.stringify({
    "type": "object",
    "properties": {
        "topic": {
            "type": "string",
...
exports.CheckDoctorAvailabilitySchema = JSON.stringify({
    "type": "object",
    "properties": {
        "doctorId": {
            "type": "string",
...
exports.CheckAppointmentsSchema = JSON.stringify({
    "type": "object",
    "properties": {
        "doctorId": {
            "type": "string",
...
exports.ScheduleAppointmentSchema = JSON.stringify({
    "type": "object",
    "properties": {
        "doctorId": {
            "type": "string",
...
exports.CancelAppointmentSchema = JSON.stringify({
    "type": "object",
    "properties": {
        "appointmentId": {
            "type": "string",
