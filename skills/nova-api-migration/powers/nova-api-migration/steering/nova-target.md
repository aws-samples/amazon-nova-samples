...
This is the **target side** of every API migration. The source-specific guide (`gemini.md`, `openai.md`, `claude.md` steering files) tells you how to read the original code; this file tells you what to produce on the Nova side. Every source guide points here so these rules are written once.
