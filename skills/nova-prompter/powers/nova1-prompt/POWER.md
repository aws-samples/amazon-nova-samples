---
name: "nova1-prompt"
displayName: "Nova 1 Prompt Optimizer"
description: "Rewrite and optimize prompts for Amazon Nova 1 models (Nova Micro, Lite, Pro, Premier). Use this power when the user wants to migrate, convert, or optimize a prompt specifically for Nova 1. Do NOT use this for Nova 2 — use nova2-prompt power instead."
keywords: ["nova", "nova1", "amazon nova", "prompt", "prompt engineering", "bedrock", "optimization"]
author: "Amazon Nova"
---

<!-- GENERATED from plugins/nova-prompting/skills/nova1-prompt/SKILL.md by scripts/sync_powers.py — do not edit by hand. Edit the SKILL.md and re-run the script. -->
...
> **You're using nova1-prompt power — this optimizes for Amazon Nova 1** (Micro / Lite / Pro / Premier).
> If you meant **Nova 2** instead, just say so and I'll point you to **nova2-prompt power**.
