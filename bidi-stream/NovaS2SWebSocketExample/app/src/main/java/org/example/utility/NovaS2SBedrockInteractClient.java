...
public class NovaS2SBedrockInteractClient {
    ...
    public NovaS2SBedrockInteractClient(BedrockRuntimeAsyncClient bedrockClient) {
    ...
    public InteractObserver<String> interactMultimodal(
        ...
        ReplayProcessor<InvokeModelWithBidiStreamInput> publisher = ReplayProcessor.createWithTime(
                1, TimeUnit.MINUTES, Schedulers.io()
        );

        var responseHandler = new NovaS2SResponseHandler(outputEventsInteractObserver);
        ...
        publisher.onNext(
                InvokeModelWithBidiStreamInput.chunkBuilder()
